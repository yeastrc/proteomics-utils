...
public class DigestionUtils_TestTrypsin {
    ...
    public void test() {
        ...
        assertEquals( products, DigestionUtils.digestProteinSequence( "ETLIKRLI", _TRYPSIN, _DIGESTION_PARAMETERS ) );
    }
