...
public class DigestionUtils_TestTrypsinWithPExclusion {
    ...
    public void test() {
        ...
        assertEquals( products, DigestionUtils.digestProteinSequence( "ETLIKPLI", _TRYPSIN, _DIGESTION_PARAMETERS ) );
    }
