...
public class DigestionUtils_TestTrypsinAllRs {
    ...
    public void testAllRs() {
        ...
        assertEquals( products, DigestionUtils.digestProteinSequence( "RRRR", _TRYPSIN, _DIGESTION_PARAMETERS ) );
    }
